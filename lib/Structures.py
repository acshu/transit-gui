...
class Task(QObject):
    ...
    def start(self):
        ...
        self.thread.set_star_darkening_1(self.input.darkening_coefficient_1)
        self.thread.set_star_darkening_2(self.input.darkening_coefficient_2)
...
class TaskInput(object):
    ...
    def __init__(self):
        ...
        self.darkening_coefficient_1 = float(0.0)
        self.darkening_coefficient_2 = float(0.0)
